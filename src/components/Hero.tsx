...
const  Hero = () => {
  const items = [
    'https://i.pinimg.com/236x/29/ba/3c/29ba3c791d008ee518ccb26a84195f93.jpg',
    'https://i.pinimg.com/236x/29/ba/3c/29ba3c791d008ee518ccb26a84195f93.jpg',
    'https://i.pinimg.com/236x/29/ba/3c/29ba3c791d008ee518ccb26a84195f93.jpg',
    'https://i.pinimg.com/236x/29/ba/3c/29ba3c791d008ee518ccb26a84195f93.jpg',
    'https://i.pinimg.com/236x/29/ba/3c/29ba3c791d008ee518ccb26a84195f93.jpg',
    ...
    <div className="relative bg-white mt-10 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center">
        ...
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:w-2/3 lg:pb-28 xl:pb-32">
          ...
          <span className="block xl:inline animate-fade-in-blur">Descubre tu estilo en</span>{" "}
          <span className="block text-pink-200 xl:inline animate-fade-in-blur delay-300">nuestra boutique</span>
        </h1>
